...
(function (global) {
   ...
   */
  function buildAllFilters(custom) {
    const filters = [];
   ...
   */
  function snapElements(elements, route, selection, limDist) {
   ...
   */
  async function findWaypoints(route, selection, limDist, onProgress) {
  ...
  global.Overpass = { bbox, segmentRoute, buildAllFilters, buildQuery, run, findWaypoints, snapElements, describeOsm };
})(window);
